...
use PlaceToPay\SDKPSE\Cache\CMemcached;
require_once(ROOT . DS  . 'vendor' . DS  . 'place-to-pay' . DS . 'php-sdk-pse' . DS . 'tests'. DS . 'Cache'. DS . 'CMemcachedTest.php' );



class CMemcachedTest 
{
	/**
